...
/// SO, WHILE DESIGNING OUR BOTTOM-SHEET, WE FACED AN ISSUE WHILE USING 'EXPANDED' WIDGET --> i.e: 'EXPANDED' WIDGET EXPANDS CHILD OF A 'FLEX' TO TAKE ALL AVAILABLE SPACE, WHICH MADE OUR BOTTOM-SHEET QUITE LARGE(AROUND HALF OF THE SCREEN). BUT WE WANTED IT TO BE 1/3 OF THE SCREEN SIZE.
///  // SO BY EXPLORING ABOUT THIS ISSUE, WE CAME ACROSS 'FLEXIBLE' WIDGET, WHICH IS MADE FOR THIS KINDA SITUATIONS, BCZ, IT DOESN'T FORCE THE CHILD OF 'FLEX' TO TAKE ALL AVAILABLE SPACE ON MAIN AXIS, SO KEEPING OUR COLUMN WIDGET AND THUS BOTTOM-SHEET OF SMALLER SIZE, WHICH IS EXACTLY WHAT WE WANTED.
///  // // SO, ANOTHER SAVIOUR IN RESOLVING THE 'OVERFLOW' ISSUE OF 'FLEX'(ROW/COLUMN) WIDGET IS 'FLEXIBLE' WIDGET(QUITE SIMILAR TO 'EXPANDED' BUT DIFF. IS DISCUSSED ABOVE WHICH MAKES IT VERY USEFUL) ALONGSIDE 'EXPANDED' & 'FITTEDBOX' WIDGETS. OTHER ONE WHICH COULD BE USEFUL IS 'WRAP'(NOT USED YET, THOUGH). EXTRA NOTE: 'SPACER' IS ANOTHER WIDGET TO ADD FLEXIBLE SPACE IN 'FLEX' CONTAINER.

/// ==> SO, HAVING THIS MUCH SAVIOUR WIDGETS, HOW CAN 'OVERFLOW' ISSUE COULD BE CAUSED IN FUTURE ?? ;-)
